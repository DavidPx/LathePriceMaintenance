...
{
    class AcmeTools : ScraperBase
    {
        protected override Uri SourceUri => new Uri("http://www.acmetools.com/shop/tools/woodworking-lathes");  // new Uri("http://www.acmetools.com/shop/tools/woodworking-lathes?fetchFacets=true#facet:&facetLimit:&productBeginIndex:0&orderBy:5&pageView:grid&minPrice:&maxPrice:&pageSize:96");
